...
export default function CoachFeedbackModal({
  ...
  <div className="flex items-center gap-2 shrink-0">
    <button
      ...
      className="inline-flex items-center gap-1.5 whitespace-nowrap text-xs font-semibold px-3 h-9 rounded-lg border border-slate-200 dark:border-zinc-700 text-slate-700 dark:text-zinc-200 hover:bg-slate-50 dark:hover:bg-zinc-800 disabled:opacity-50 transition-colors"
    >
    ...
    <button
      onClick={onClose}
      className="inline-flex items-center gap-1.5 whitespace-nowrap text-xs font-bold px-4 h-9 rounded-lg bg-slate-900 dark:bg-zinc-100 text-white dark:text-zinc-900 hover:bg-slate-800 dark:hover:bg-zinc-200 transition-colors"
    >
      Got it
